...
const primaryNav: NavItem[] = [
  ...
  { label: "Statistics", href: "/", icon: BarChart3, key: "stats" },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6 px-4 pt-7 pb-6">
        <Image src="/logogif.gif" alt="Grass logo" width={70} height={70} className="rounded-full object-cover" />
        <div className="leading-tight">
          <div className="text-3xl md:text-4xl font-extrabold text-foreground text-pretty">Grass</div>
          <div className="text-[13px] tracking-[0.18em] text-foreground/60">@Grassdotfun</div>
        </div>
      </div>
