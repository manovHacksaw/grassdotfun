...
export default function UserStats() {
  ...
  useEffect(() => {
    if (contractUserStats && !contractUserStats.isLoading && contractUserStats.totalBet) {
      try {
        ...
        setUserStats(prevStats => {
          // If no previous stats, always update
          if (!prevStats) {
    ...
    contractUserStats?.totalBet,
    contractUserStats?.totalWon,
    contractUserStats?.totalLost,
    contractUserStats?.withdrawableBalance,
    contractUserStats?.gamesPlayed,
    contractUserStats?.gamesWon,
    contractUserStats?.joinTimestamp,
    contractUserStats?.lastPlayTimestamp,
    contractUserStats?.isLoading,
    contractUserStats?.winRate
  ])
